...
('mod-transmog', 2, 'Invalid source item.'),
('mod-transmog', 3, 'All slot transmogs removed.'),
('mod-transmog', 4, 'Slot hidden.'),
('mod-transmog', 5, 'Slot transmog removed.'),
('mod-transmog', 6, 'You do not have enough money.'),
('mod-transmog', 7, 'Remove all transmogs'),
('mod-transmog', 8, 'Remove all slot transmogs?'),
('mod-transmog', 9, 'Back...'),
('mod-transmog', 10, 'Hide slot'),
('mod-transmog', 11, 'Remove transmog from slot'),
('mod-transmog', 12, 'Next Page'),
('mod-transmog', 13, 'Previous Page'),
('mod-transmog', 14, 'No valid appearances found for this slot.'),
('mod-transmog', 15, 'This item\'s appearance has been added to your collection.'),
('mod-transmog', 16, 'Free');
