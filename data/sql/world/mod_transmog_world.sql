...
(@TEXT_ID, 'Slot transmogrification changes how each equipment slot looks. The appearance stays on the slot even when you equip a new item.\r\n\r\nOnly armor and weapons can be transmogrified.\r\nGuns, bows and crossbows can be transmogrified with each other.\r\nFishing poles cannot be transmogrified.\r\nYou must be able to equip the source appearance.\r\n\r\nYou can hide an armor slot to make it appear empty. Weapons, jewelry, and trinkets cannot be hidden.');
...
('mod-transmog', 8, 'How does slot transmogrification work?'),
('mod-transmog', 9, 'Remove all transmogs'),
('mod-transmog', 10, 'Remove all slot transmogs?'),
('mod-transmog', 11, 'Back...'),
('mod-transmog', 12, 'Hide slot'),
('mod-transmog', 13, 'Remove transmog from slot'),
('mod-transmog', 14, 'Next Page'),
('mod-transmog', 15, 'Previous Page'),
('mod-transmog', 16, 'No valid appearances found for this slot.'),
('mod-transmog', 17, 'This item\'s appearance has been added to your collection.'),
('mod-transmog', 18, 'Free');
